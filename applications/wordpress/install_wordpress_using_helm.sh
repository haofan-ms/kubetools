...
helm install stable/wordpress --set wordpressSkipInstall=false,nodeSelector."beta\.kubernetes\.io/os"=linux,mariadb.master.nodeSelector."beta\.kubernetes\.io/os"=linux
